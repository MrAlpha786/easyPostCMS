...
@section('content')
    ...
    <div class="bg-slate-200 p-4 mt-4 rounded-md shadow-md ">
        <x-searchbar route="{{ route('userList') }}" />
                        ...
                        <td class="p-2">
                            <div class="flex items-center justify-center">
                                ...
                                <x-secondaryButton title="Delete Profile" class="p-2 m-2"
                                    onclick="event.preventDefault(); document.getElementById('delete-employee-form').submit();">
                                    <i class="fas fa-trash"></i>
                                    <form id="delete-employee-form" action="{{ route('deleteUser', $user->id) }}"
